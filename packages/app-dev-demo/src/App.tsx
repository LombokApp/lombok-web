        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white/5 border border-white/10 backdrop-blur-sm rounded-lg p-6">
            ...
            <p className="text-white/70">
              ...
              for the fastest user experience.
            </p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 backdrop-blur-sm rounded-lg p-6">
            ...
            <p className="text-white/70">
              Bank-grade security with end-to-end encryption and compliance with
              industry standards.
            </p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 backdrop-blur-sm rounded-lg p-6">
            ...
            <p className="text-white/70">
              Intelligent auto-scaling that adapts to your traffic patterns and
