...
export class StorageLocationNotFoundError extends Error implements HttpError {
  name = StorageLocationNotFoundError.name;
...
@Log(LogLevel.Debug, 'stack')
export class StorageLocationInvalidError extends Error implements HttpError {
  name = StorageLocationInvalidError.name;
