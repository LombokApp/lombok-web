...
export function RegisterRoutes(
  ...
  app.post(
    ...
    function AuthController_refreshToken(
      request: any,
      response: any,
      next: any,
    ) {
  ...
  app.post(
    ...
    function FoldersController_createFolder(
      request: any,
      response: any,
      next: any,
    ) {
      const args = {
        ...
        body: {
          ...
          nestedProperties: {
            metadataLocation: { ref: 'UserLocationInputData' },
            contentLocation: { ref: 'UserLocationInputData', required: true },
      ...
      const controller: any =
        container.get<FoldersController>(FoldersController)
      if (typeof controller['setStatus'] === 'function') {
        controller.setStatus(undefined)
      }

      const promise = controller.createFolder.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.get(
    ...
    function FoldersController_getFolder(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.getFolder.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.get(
    ...
    function FoldersController_listFolders(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.listFolders.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.delete(
    ...
    function FoldersController_deleteFolder(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.deleteFolder.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.get(
    ...
    function FoldersController_getFolderMetadata(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.getFolderMetadata.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.get(
    ...
    validator.validate(
      'get',
      convertPath('/folders/:folderId/objects/:objectKey'),
    ),
    function FoldersController_getFolderObject(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.getFolderObject.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.delete(
    ...
    function FoldersController_deleteFolderObject(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.deleteFolderObject.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.get(
    ...
    function FoldersController_listFolderObjects(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.listFolderObjects.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.put(
    ...
    function FoldersController_refreshFolderObjectS3Metadata(
      request: any,
      response: any,
      next: any,
    ) {
      const args = {
        ...
        body: {
          ...
          required: true,
          dataType: 'nestedObjectLiteral',
          nestedProperties: { eTag: { dataType: 'string' } },
        },
      }
      ...
      const promise = controller.refreshFolderObjectS3Metadata.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.post(
    ...
    function FoldersController_refreshFolder(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.refreshFolder.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.post(
    ...
    validator.validate(
      'post',
      convertPath('/folders/:folderId/presigned-urls'),
    ),
    function FoldersController_createPresignedUrls(
      request: any,
      response: any,
      next: any,
    ) {
      const args = {
        ...
        body: {
          ...
          required: true,
          dataType: 'array',
          array: { dataType: 'refObject', ref: 'SignedURLsRequest' },
        },
      }
      ...
      const promise = controller.createPresignedUrls.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.get(
    ...
    validator.validate(
      'get',
      convertPath('/server/settings/server-locations/:locationType'),
    ),
    function ServerController_listServerLocations(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.listServerLocations.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.post(
    ...
    validator.validate(
      'post',
      convertPath('/server/settings/locations/:locationType'),
    ),
    function ServerController_addServerConfigLocation(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.addServerConfigLocation.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.delete(
    ...
    validator.validate(
      'delete',
      convertPath('/server/settings/locations/:locationType/:locationId'),
    ),
    function ServerController_deleteServerConfigLocation(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.deleteServerConfigLocation.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.get(
    ...
    function ServerController_listUsers(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.listUsers.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.get(
    ...
    function ServerController_getUsers(request: any, response: any, next: any) {
      ...
      const promise = controller.getUsers.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.post(
    ...
    function ServerController_createUser(
      request: any,
      response: any,
      next: any,
    ) {
  ...
  app.put(
    ...
    function ServerController_updateUser(
      request: any,
      response: any,
      next: any,
    ) {
  ...
  app.delete(
    ...
    function ServerController_deleteUser(
      request: any,
      response: any,
      next: any,
    ) {
  ...
  app.get(
    ...
    function ServerController_getSettings(
      request: any,
      response: any,
      next: any,
    ) {
  ...
  app.get(
    ...
    function ServerController_listModules(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.listModules.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.put(
    ...
    function ServerController_updateSetting(
      request: any,
      response: any,
      next: any,
    ) {
      const args = {
        ...
        settingsValue: {
          ...
          required: true,
          dataType: 'nestedObjectLiteral',
          nestedProperties: { value: { dataType: 'any', required: true } },
        },
      }
      ...
      const promise = controller.updateSetting.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.delete(
    ...
    function ServerController_resetSetting(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.resetSetting.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.get(
    ...
    function ViewerController_getViewer(
      request: any,
      response: any,
      next: any,
    ) {
      ...
      const promise = controller.getViewer.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
  ...
  app.put(
    ...
    function ViewerController_updateViewer(
      request: any,
      response: any,
      next: any,
    ) {
      const args = {
        ...
        viewerUpdatePayload: {
          in: 'body',
          name: 'viewerUpdatePayload',
          required: true,
          ref: 'ViewerUpdatePayload',
        },
      }
      ...
      const promise = controller.updateViewer.apply(
        controller,
        getArgs(args, request, response),
      )
      promiseHandler(controller, promise, response, undefined, next)
