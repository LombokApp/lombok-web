...
import { configureS3Client, S3Service } from 'src/core/services/s3.service'
import { v4 as uuidV4 } from 'uuid'

// import { QueueName } from '../../../constants/app-worker-constants'
// import { QueueService } from '../../../services/queue.service'
import { SocketService } from '../../core/services/socket.service'
import { parseSort } from '../../core/utils/sort.util'
...
import type { UserLocationInputData } from '../../locations/transfer-objects/location.dto'
      ...
      if (withNewUserLocationConnection.success) {
        ...
        if (existingLocation) {
          ...
          throw new NotFoundException(
            undefined,
            `Storage location not found by id "${withExistingUserLocation.value.userLocationId}"`,
          )
        }
        ...
        if (!existingServerLocation) {
          throw new NotFoundException(
            undefined,
            `Storage location not found by id "${withExistingServerLocation.value.serverLocationId}"`,
          )
        }
