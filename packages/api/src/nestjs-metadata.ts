...
export default async () => {
  const t = {
    ['../src/storage/dto/responses/access-key-list-response.dto']: await import(
      '../src/storage/dto/responses/access-key-list-response.dto'
    ),
    ['../src/storage/dto/responses/access-key-get-response.dto']: await import(
      '../src/storage/dto/responses/access-key-get-response.dto'
    ),
    ['../src/storage/dto/responses/access-key-rotate-response.dto']:
      await import(
        '../src/storage/dto/responses/access-key-rotate-response.dto'
      ),
    ['../src/storage/dto/responses/access-key-buckets-list-response.dto']:
      await import(
        '../src/storage/dto/responses/access-key-buckets-list-response.dto'
      ),
    ['../src/task/dto/responses/task-get-response.dto']: await import(
      '../src/task/dto/responses/task-get-response.dto'
    ),
    ['../src/task/dto/responses/task-list-response.dto']: await import(
      '../src/task/dto/responses/task-list-response.dto'
    ),
    ...
    ['../src/folders/dto/responses/folder-share-get-response.dto']:
      await import(
        '../src/folders/dto/responses/folder-share-get-response.dto'
      ),
    ['../src/folders/dto/responses/folder-share-list-response.dto']:
      await import(
        '../src/folders/dto/responses/folder-share-list-response.dto'
      ),
    ['../src/folders/dto/responses/folder-share-user-list-response.dto']:
      await import(
        '../src/folders/dto/responses/folder-share-user-list-response.dto'
      ),
    ['../src/folders/dto/responses/folder-update-response.dto']: await import(
      '../src/folders/dto/responses/folder-update-response.dto'
    ),
    ['../src/app/dto/responses/app-folder-settings-get-response.dto']:
      await import(
        '../src/app/dto/responses/app-folder-settings-get-response.dto'
      ),
    ...
    ['../src/event/dto/responses/event-list-response.dto']: await import(
      '../src/event/dto/responses/event-list-response.dto'
    ),
    ['../src/app/dto/responses/app-list-response.dto']: await import(
      '../src/app/dto/responses/app-list-response.dto'
    ),
    ['../src/app/dto/responses/app-get-response.dto']: await import(
      '../src/app/dto/responses/app-get-response.dto'
    ),
    ['../src/app/dto/responses/string-map.dto']: await import(
      '../src/app/dto/responses/string-map.dto'
    ),
    ['../src/app/dto/responses/user-app-list-response.dto']: await import(
      '../src/app/dto/responses/user-app-list-response.dto'
    ),
    ['../src/app/dto/responses/user-app-get-response.dto']: await import(
      '../src/app/dto/responses/user-app-get-response.dto'
    ),
    ['../src/app/dto/responses/app-contributions-response.dto']: await import(
      '../src/app/dto/responses/app-contributions-response.dto'
    ),
    ['../src/auth/dto/responses/login-response.dto']: await import(
      '../src/auth/dto/responses/login-response.dto'
    ),
    ['../src/app/dto/responses/app-user-settings-get-response.dto']:
      await import(
        '../src/app/dto/responses/app-user-settings-get-response.dto'
      ),
    ['../src/server/dto/responses/public-settings-get-response.dto']:
      await import(
        '../src/server/dto/responses/public-settings-get-response.dto'
      ),
    ...
    ['../src/server/dto/responses/install-apps-response.dto']: await import(
      '../src/server/dto/responses/install-apps-response.dto'
    ),
    ['../src/server/dto/responses/server-metrics-response.dto']: await import(
      '../src/server/dto/responses/server-metrics-response.dto'
    ),
    ['../src/server/dto/responses/server-storage-location-get-response.dto']:
      await import(
        '../src/server/dto/responses/server-storage-location-get-response.dto'
      ),
    ...
    ['../src/server/dto/responses/storage-provision-get-response.dto']:
      await import(
        '../src/server/dto/responses/storage-provision-get-response.dto'
      ),
    ...
    ['../src/server/dto/responses/user-session-list-response.dto']:
      await import(
        '../src/server/dto/responses/user-session-list-response.dto'
      ),
    ...
    ['../src/auth/dto/sso/responses/complete-sso-signup-response.dto']:
      await import(
        '../src/auth/dto/sso/responses/complete-sso-signup-response.dto'
      ),
    ['../src/auth/dto/sso/responses/initiate-sso-response.dto']: await import(
      '../src/auth/dto/sso/responses/initiate-sso-response.dto'
    ),
    ['../src/auth/dto/sso/responses/sso-callback-response.dto']: await import(
      '../src/auth/dto/sso/responses/sso-callback-response.dto'
    ),
    ['../src/auth/dto/sso/responses/link-provider-response.dto']: await import(
      '../src/auth/dto/sso/responses/link-provider-response.dto'
    ),
    ['../src/log/dto/responses/log-get-response.dto']: await import(
      '../src/log/dto/responses/log-get-response.dto'
    ),
    ['../src/log/dto/responses/log-list-response.dto']: await import(
      '../src/log/dto/responses/log-list-response.dto'
    ),
  }
  return {
    '@nestjs/swagger': {
      models: [
        [
          import('../src/server/dto/server-storage-input.dto'),
          { ServerStorageInputDTO: {} },
        ],
        [
          import('../src/server/dto/storage-provision-input.dto'),
          { StorageProvisionInputDTO: {}, StorageProvisionUpdateDTO: {} },
        ],
        [
        ...
        [
          import('../src/auth/dto/sso/complete-sso-signup.dto'),
          { CompleteSSOSignupDTO: {} },
        ],
        [import('../src/users/dto/user.dto'), { UserDTO: {} }],
        [
          import('../src/auth/dto/sso/responses/sso-callback-response.dto'),
          { SSOCallbackResponse: {} },
        ],
        [
          import('../src/server/dto/public-settings.dto'),
          { PublicSettingsDTO: {} },
        ],
        ...
        [
          import('../src/storage/dto/storage-location-input.dto'),
          { StorageLocationInputDTO: {} },
        ],
        [import('../src/folders/dto/folder-share.dto'), { FolderShareDTO: {} }],
        [
          import('../src/folders/dto/folder-shares-list-query-params.dto'),
          { FolderShareUsersListQueryParamsDTO: {} },
        ],
        [
          import('../src/app/dto/app-folder-settings-update-input.dto'),
          { AppFolderSettingsUpdateInputDTO: {} },
        ],
        [
          import('../src/app/dto/apps-list-query-params.dto'),
          { AppsListQueryParamsDTO: {} },
        ],
        [
          import('./app/dto/app-folder-settings.dto'),
          { FolderUserSettingsDTO: {} },
        ],
        [
          import(
            '../src/app/dto/responses/app-folder-settings-get-response.dto'
        ...
        [
          import('../src/app/dto/app-user-settings.dto'),
          { AppUserSettingsDTO: {} },
        ],
        [
          import('../src/app/dto/responses/app-user-settings-get-response.dto'),
          { AppUserSettingsGetResponseDTO: {} },
        ],
        [
          import('../src/app/dto/update-app-access-settings-input.dto'),
          { UpdateAppAccessSettingsInputDTO: {} },
        ],
        [
          import('../src/platform/dto/api-error-response.dto'),
          { ApiErrorResponseDTO: {} },
        ],
        [
          import('../src/storage/dto/rotate-access-key-input.dto'),
          { RotateAccessKeyInputDTO: {} },
        ],
        [
          import('../src/storage/dto/access-key-list-query-params.dto'),
          { AccessKeyListQueryParamsDTO: {} },
        ],
        [
          import(
            '../src/storage/dto/responses/access-key-buckets-list-response.dto'
        ...
        [
          import('../src/storage/dto/responses/access-key-get-response.dto'),
          { AccessKeyGetResponse: {} },
        ],
        [
          import('../src/storage/dto/responses/access-key-list-response.dto'),
          { AccessKeyListResponse: {} },
        ],
        [
          import('../src/storage/dto/responses/access-key-rotate-response.dto'),
          { AccessKeyRotateResponse: {} },
        ],
        [import('../src/task/dto/task.dto'), { TaskDTO: {} }],
        [
          import('../src/task/dto/responses/task-get-response.dto'),
          { TaskGetResponse: {} },
        ],
        [
          import('../src/task/dto/responses/task-list-response.dto'),
          { TaskListResponse: {} },
        ],
        [
          import('../src/task/dto/folder-tasks-list-query-params.dto'),
          { FolderTasksListQueryParamsDTO: {} },
        ],
        [
          import('../src/task/dto/tasks-list-query-params.dto'),
          { TasksListQueryParamsDTO: {} },
        ],
        [
          import('../src/folders/dto/content-metadata.dto'),
          {
        ...
        [
          import('../src/folders/dto/folder-share-create-input.dto'),
          { FolderShareCreateInputDTO: {} },
        ],
        [
          import('../src/folders/dto/folder-update-input.dto'),
        ...
        [
          import('../src/storage/dto/storage-location.dto'),
          { StorageLocationDTO: {} },
        ],
        ...
        [
          import('../src/folders/dto/responses/folder-share-get-response.dto'),
          { FolderShareGetResponse: {} },
        ],
        [
          import('../src/folders/dto/responses/folder-share-list-response.dto'),
        ...
        [
          import('../src/folders/dto/responses/folder-update-response.dto'),
          { FolderUpdateResponseDTO: {} },
        ],
        [
          import('../src/folders/dto/trigger-app-task-input.dto'),
          { TriggerAppTaskInputDTO: {} },
        ],
        [
          import('../src/event/dto/folder-events-list-query-params.dto'),
          { FolderEventsListQueryParamsDTO: {} },
        ],
        ...
        [
          import('../src/event/dto/responses/event-list-response.dto'),
          { EventListResponse: {} },
        ],
        [
          import('../src/event/dto/events-list-query-params.dto'),
          { EventsListQueryParamsDTO: {} },
        ],
        [import('../src/app/dto/admin-app.dto'), { AdminAppDTO: {} }],
        [
          import('../src/app/dto/responses/app-get-response.dto'),
          { AppGetResponse: {} },
        ],
        [
        ...
        [
          import('../src/app/dto/responses/string-map.dto'),
          { StringMapDTO: {} },
        ],
        [
          import('../src/app/dto/set-app-enabled-input.dto'),
          { SetAppEnabledInputDTO: {} },
        ],
        [
          import('../src/app/dto/set-worker-environment-variables-input.dto'),
        ...
        [
          import('../src/app/dto/app-user-settings-create-input.dto'),
          { AppUserSettingsCreateInputDTO: {} },
        ],
        [
          import('../src/app/dto/responses/app-contributions-response.dto'),
          { AppContributionsResponse: {} },
        ],
        [import('../src/app/dto/user-app.dto'), { UserAppDTO: {} }],
        [
          import('../src/app/dto/responses/user-app-get-response.dto'),
          { UserAppGetResponse: {} },
        ],
        [
          import('../src/app/dto/responses/user-app-list-response.dto'),
          { UserAppListResponse: {} },
        ],
        [
          import(
        ...
        [
          import('../src/server/dto/responses/install-apps-response.dto'),
          {
            InstallAppsResponse: {
        ...
        [
          import('../src/server/dto/responses/server-metrics-response.dto'),
        ...
        [
          import('../src/server/dto/responses/user-session-list-response.dto'),
        ...
        [
          import('../src/users/dto/viewer-update-input.dto'),
        ...
        [
          import('../src/auth/dto/sso/link-sso-provider.dto'),
          { LinkSSOProviderDTO: {} },
        ],
        [
          import(
        ...
        [
          import('../src/auth/dto/sso/responses/initiate-sso-response.dto'),
          { InitiateSSOResponse: {} },
        ],
        [
          import('../src/auth/dto/sso/responses/link-provider-response.dto'),
          { LinkProviderResponse: {} },
        ],
        [
          import('../src/auth/dto/sso/sso-callback.dto'),
          { SSOCallbackDTO: {} },
        ],
        [
          import('../src/log/dto/folder-logs-list-query-params.dto'),
          { FolderLogsListQueryParamsDTO: {} },
        ],
        [import('../src/log/dto/log-entry.dto'), { LogEntryDTO: {} }],
        [
          import('../src/log/dto/responses/log-get-response.dto'),
          { LogGetResponse: {} },
        ],
        [
          import('../src/log/dto/responses/log-list-response.dto'),
          { LogListResponse: {} },
        ],
        [
          import('../src/log/dto/logs-list-query-params.dto'),
          { LogsListQueryParamsDTO: {} },
        ],
        [
          import('../src/users/dto/user-email-update-input.dto'),
          { UserEmailUpdateInputDTO: {} },
        ],
        [import('../src/app/dto/task-config.dto'), { TaskConfigDTO: {} }],
        [
          import('../src/app/dto/responses/app-external-worker.dto'),
          { ExternalAppWorker: {} },
        ],
        [
          import('../src/app/dto/responses/admin-app-get-response.dto'),
          { AdminAppGetResponse: {} },
        ],
      ],
      controllers: [
        [
          import('../src/storage/controllers/access-keys.controller'),
          {
        ...
        [
          import('../src/storage/controllers/server-access-keys.controller'),
          {
        ...
        [
          import('../src/task/controllers/server-tasks.controller'),
          {
            ServerTasksController: {
              getTask: {
                summary: 'Get a task by id.',
                type: t['../src/task/dto/responses/task-get-response.dto']
                  .TaskGetResponse,
              },
              listTasks: {
                summary: 'List tasks.',
                type: t['../src/task/dto/responses/task-list-response.dto']
                  .TaskListResponse,
              },
            },
          },
        ...
        [
          import('../src/task/controllers/tasks.controller'),
          {
            TasksController: {
              getFolderTask: {
        ...
        [
          import('../src/folders/controllers/folders.controller'),
          {
            FoldersController: {
              ...
              deleteFolder: { summary: 'Delete a folder by id.' },
              reindexFolder: {
                summary:
              ...
              handleAppTaskTrigger: { summary: 'Handle app task trigger' },
              getFolderShares: {
              ...
              removeFolderShare: { summary: 'Remove a folder share' },
              updateFolder: {
        ...
        [
          import('../src/event/controllers/folder-events.controller'),
          {
            FolderEventsController: {
              getFolderEvent: {
              ...
              listFolderEvents: {
                summary: 'List tasks.',
                type: t['../src/event/dto/responses/event-list-response.dto']
                  .EventListResponse,
              },
            },
          },
        ...
        [
          import('../src/event/controllers/server-events.controller'),
          {
        ...
        [
          import('../src/app/controllers/apps.controller'),
          {
            AppsController: {
              ...
              setAppEnabled: {
                type: t['../src/app/dto/responses/app-get-response.dto']
                  .AppGetResponse,
              },
              getApp: {
                type: t['../src/app/dto/responses/app-get-response.dto']
              ...
              setWorkerEnvironmentVariables: {
                type: t['../src/app/dto/responses/string-map.dto'].StringMapDTO,
              },
            },
          },
        ],
        [
          import('../src/app/controllers/user-apps.controller'),
          {
            UserAppsController: {
              listApps: {
                summary: 'List enabled apps available for the current user',
                type: t['../src/app/dto/responses/user-app-list-response.dto']
                  .UserAppListResponse,
              },
              getApp: {
                summary:
                  'Get an enabled app by identifier for the current user',
                type: t['../src/app/dto/responses/user-app-get-response.dto']
                  .UserAppGetResponse,
              },
              getAppContributions: {
        ...
        [
          import('../src/server/controllers/public.controller'),
          {
            PublicController: {
        ...
        [
          import('../src/server/controllers/server.controller'),
          {
            ServerController: {
              ...
              installLocalApps: {
                summary: 'Install all apps from disk.',
                type: t['../src/server/dto/responses/install-apps-response.dto']
                  .InstallAppsResponse,
              },
              getServerMetrics: {
                summary:
        ...
        [
          import('../src/server/controllers/server-storage.controller'),
          {
        ...
        [
          import('../src/users/controllers/users.controller'),
          {
            UsersController: {
              ...
              deleteUser: { summary: 'Delete a server user by id.' },
        ...
        [
          import('../src/auth/controllers/sso.controller'),
          {
            SSOController: {
              completeSignup: {
        ...
        [
          import('../src/log/controllers/folder-logs.controller'),
          {
            FolderLogsController: {
              getFolderLog: {
                summary: 'Get a folder log entry by id.',
                type: t['../src/log/dto/responses/log-get-response.dto']
                  .LogGetResponse,
              },
              listFolderLogs: {
                summary: 'List folder log entries.',
                type: t['../src/log/dto/responses/log-list-response.dto']
                  .LogListResponse,
              },
            },
          },
        ...
        [
          import('../src/log/controllers/server-logs.controller'),
          {
