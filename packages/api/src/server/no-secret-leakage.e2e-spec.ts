...
describe('No Secret Leakage', () => {
  ...
  describe('Server Settings', () => {
    // External storage provisions are no longer a server setting (they live in
    // their own table); the dedicated /storage-provisions secret-leakage tests
    // above cover redaction. Server storage is the embedded builtin (no secrets
    // are ever surfaced via settings).
