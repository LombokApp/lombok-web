...
CREATE TABLE IF NOT EXISTS "folder_operations" (
	...
	"error" text,
	"folderId" uuid NOT NULL,
	"assignedFolderWorkerId" uuid,
	"assignedAt" timestamp,
	"createdAt" timestamp NOT NULL,
	"updatedAt" timestamp NOT NULL
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "folder_worker_keys" (
	"id" uuid PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "folder_workers" (
	"id" uuid PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "folder_operations" ADD CONSTRAINT "folder_operations_assignedFolderWorkerId_folder_workers_id_fk" FOREIGN KEY ("assignedFolderWorkerId") REFERENCES "folder_workers"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "folder_worker_keys" ADD CONSTRAINT "folder_worker_keys_ownerId_users_id_fk" FOREIGN KEY ("ownerId") REFERENCES "users"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "folder_workers" ADD CONSTRAINT "folder_workers_keyId_folder_worker_keys_id_fk" FOREIGN KEY ("keyId") REFERENCES "folder_worker_keys"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
