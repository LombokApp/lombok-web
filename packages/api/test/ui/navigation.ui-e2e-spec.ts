...
describe('UI E2E - Navigation', () => {
  ...
  it('should have working browser back button between authenticated pages', async () => {
    ...
    await page.waitForURL(testModule!.frontendBaseUrl)
    expect(page.url()).toContain(testModule!.frontendBaseUrl)

    // Go back
    await page.goBack()
    await page.waitForURL(foldersUrl)
  ...
  it('should have working browser forward button', async () => {
    ...
    expect(page.url()).toBe(`${testModule!.frontendBaseUrl}/`)
  }, 30000)
